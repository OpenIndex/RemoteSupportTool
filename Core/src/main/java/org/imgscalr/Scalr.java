 ...
 * <a href="http://today.java.net/pub/a/today/2007/04/03/perils-of-image-getscaledinstance.html">Perils of Image.getScaledInstance()</a>
 ...
 * <a href="http://gman.eichberger.de/2007/07/transparent-gifs-in-java.html">here</a> and
...
public class Scalr {
     ...
     * that actually executes the Op code,
     * <a href="http://www.docjar.com/html/api/sun/awt/image/ImagingLib.java.html">sun.awt.image.ImagingLib</a>.
     * <h3>Known Issues</h3>
     ...
     * <a href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=4965606">a decade-old JDK bug</a>
     * that can cause a {@link RasterFormatException}
     ...
     * @param message The log message in
     *                <a href="http://download.oracle.com/javase/6/docs/api/java/util/Formatter.html#syntax">format string syntax</a>
     *                that will be logged.
